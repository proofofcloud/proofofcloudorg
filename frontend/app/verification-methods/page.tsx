    ...
    <main className="flex flex-col">
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6">
          <h1 className="text-5xl font-bold mb-6">Verification Methods</h1>
          ...
          <article className="space-y-16">
            {/* Level 1 */}
            <section>
              <h2 className="text-4xl font-bold mb-8 pt-8">Level 1: Human-Assisted Verification</h2>
              ...
              <div className="space-y-10">
                <div className="border rounded-xl p-6 bg-muted/20">
                  ...
                  <ol className="space-y-2 text-lg text-muted-foreground leading-relaxed list-decimal pl-6">
                  ...
                  <div className="bg-background border rounded-lg p-5 mt-6">
                ...
                <div className="border rounded-xl p-6 bg-muted/20">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-l-2 border-primary pl-4">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Verify inbound/outbound IP addresses are within datacenter's range via video witness of <code className="bg-muted px-1.5 py-0.5 rounded text-xs">curl ipconfig.me</code> and <code className="bg-muted px-1.5 py-0.5 rounded text-xs">mtr</code>.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section>
              ...
              <div className="space-y-10">
                ...
                <div className="border rounded-xl p-6 bg-muted/20">
                  ...
                  <ul className="space-y-2 text-muted-foreground text-sm list-disc pl-6 mb-6">
                  ...
                  <p className="text-lg font-semibold mb-3">Initial Setup Ceremony:</p>
                  <ol className="space-y-2 text-muted-foreground text-sm list-decimal pl-6 mb-6">
                    <li>Attach RFID tags as described above</li>
                    <li>Read tags and record their cryptographic identities</li>
                    <li>Connect to server via VGA console and produce remote attestation to extract hardware ID</li>
                    <li>Record setup session or conduct live video witness (similar to L1 verification)</li>
                  </ol>
                  ...
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-5 mt-4">
                    <p className="text-sm font-semibold mb-2 text-amber-700 dark:text-amber-400">Authorized Maintenance</p>
